...
$('#sendOrder').click(function(){
    ...
    function send(){
        ...
        $(".smuzi-price__title").css("display", "none");
        $(".smuzi-price").css("border", "none");
        $(".empty").css("height", "0");
    }   $(".promonabor__sendmessage").css("margin-top", "0");
